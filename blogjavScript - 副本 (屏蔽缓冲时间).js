...
(function() {
    ...
    var filterWordsArray = new Array(
        'UNCENSORED','CENSORED','IDOL','Caribbeancompr','Caribbeancom','Gachinco','10musume','天然むすめ','カリビアンコム プレミアム','カリビアンコム','PPV',
    ...
    var wordsArray = new Array(
        ...
        'Blacked','\[21members\]','\[sexart\]','Heyzo', 'X1X','\[babes\]','Mywife-NO','Peepsamurai','',''
    );
        ...
        static crtOutLink(avCode){
            var p = $(`
                <p style="text-align: center;color: blue;margin: 0 auto;clear: both;">他站查找 [${avCode}]：
                    ...
                    <a target="_blank" href="https://btsow.pw/search/${avCode}" title="搜 ${avCode}" class="link">btsow</a>&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                GM_xmlhttpRequest({
                    ...
                    onload: function(XMLHttpRequest) {
                        ...
                        if( img_start_idx > 0)
                        {
                            ...
                            //let queue = parseInt($imgCover.attr("queue"));
                            //设置延迟时间，单位毫秒
                            // let time = 0;
                            // if(queue <= 2){
                            //     time = 0;
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        //<meta http-equiv="refresh" content="1200"> 删除每20分钟刷新一次
